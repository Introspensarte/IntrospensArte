...
import { Shield, Users, FileText, MessageSquare, Calendar, Settings, Plus } from "lucide-react";
                      ...
                      <div
                        ...
                        className={`p-4 rounded-lg border cursor-pointer transition-all duration-300 ${
                          selectedUser?.id === userItem.id
                            ? 'border-soft-lavender/50 bg-soft-lavender/10'
                            : 'border-medium-gray/20 hover:border-soft-lavender/30'
                        }`}
                      >
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-light-gray mt-1">{userItem.rank}</p>
                          </div>
                    ...
                    <Form {...userForm}>
                      <form onSubmit={userForm.handleSubmit((data) => updateUserMutation.mutate({ ...data, userId: selectedUser.id }))} className="space-y-4">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-light-gray">Trazos Manuales</FormLabel>
                              <FormControl>
                                <Input
                                  {...field}
                                  type="number"
